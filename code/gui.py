...
class Application(Frame):
	def create_widgets(self):
		self.image = Image.open('pictures/back.jpg')
		...
		titleText = "Speak or Write!"
		self.Title = Label(self.imageBG, text = titleText, bg = '#D3D3D3')
		self.Title.place(relx = 0.2, rely = 0.1, anchor = N)
		self.Title.config(font = ('Helvetica', 22))

		self.imgSpeak = Image.open('pictures/voice.png')
		...
		self.imgType = Image.open('pictures/text.png')
	...
	def _createPictures_old(self, notebook):
		...
		bird_imga0 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g0.png')
		bird_imga0 = bird_imga0.resize((580, 150))
		bird_imga0 = ImageTk.PhotoImage(bird_imga0)

		bird_imga1 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g1.png')
		...
		bird_img1a0 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g0.png')
		bird_img1a0 = bird_img1a0.resize((580, 150))
		bird_img1a0 = ImageTk.PhotoImage(bird_img1a0)

		bird_img1a1 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g1.png')
		bird_img1a1 = bird_img1a1.resize((580, 150))
		bird_img1a1 = ImageTk.PhotoImage(bird_img1a1)
		bird_img1g0 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g0.png'))
		bird_img1g1 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g1.png'))
		bird_img1g2 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g2.png'))
	...
	def _createPictures_new(self, notebook):
		...
		bird_imga2 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g2.png')
		...
		bird_img1a2 = Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g2.png')
		bird_img1a2 = bird_img1a2.resize((580, 150))
		bird_img1a2 = ImageTk.PhotoImage(bird_img1a2)
		bird_img1g0 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g0.png'))
		bird_img1g1 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g1.png'))
		bird_img1g2 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g2.png'))
		bird_img1g3 = ImageTk.PhotoImage(Image.open('../models/bird_AttnGAN2/example_captions/0_s_0_g3.png'))
